@extends('layouts.app')
@section('title')
    Reset Password | {{$settings['website_name']}}
@endsection
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="padding-top: 100px">
                            ...
                            <div class="subheader-titles">
                                <h2 class="subheader-maintitle">ACOUNT SETTINGS</h2>
                                <h4 class="subheader-subtitle">PASSWORD RESET</h4>
                            </div>
                            <!--/ Sub-header titles -->
                        </div>
                        <!--/ col-sm-6 -->
    ...
    <div class="container" style="padding-top: 30px; padding-bottom: 50px">
        <h4 class="text-center">You are almost done, one more step to reset your account password.</h4>
        <p class="text-center">Please, enter your e-mail address again below, and the new password you'd like to use.</p>
        <br>
        <div class="row">
