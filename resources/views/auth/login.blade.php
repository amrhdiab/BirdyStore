@extends('layouts.app')
@section('title')
    Account Login | {{$settings['website_name']}}
@endsection
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="padding-top: 100px">
                            ...
                            <div class="subheader-titles">
                                ...
                                <h4 class="subheader-subtitle">LOGIN</h4>
                            </div>
                            <!--/ Sub-header titles -->
                        </div>
                        <!--/ col-sm-6 -->
...
<div class="container" style="padding-top: 30px; padding-bottom: 50px">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h5 style="text-align: center">You need to login to your account to start shopping, and enjoy all many other features.</h5>
    ...
    <a class="btn btn-link aligncenter" href="{{ route('register') }}">New user? Sign up for new account.</a>
</div>
@endsection