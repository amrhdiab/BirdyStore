...
@section('title')
    My Orders | {{$settings['website_name']}}
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="padding-top: 100px">
                            ...
                            <div class="subheader-titles">
                                ...
                                <h4 class="subheader-subtitle">ALL ORDERS</h4>
                            </div>
                            <!--/ Sub-header titles -->
                        </div>
                        <!--/ col-sm-6 -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="kl-title-block clearfix text-left tbk-symbol--line tbk-icon-pos--after-title">
                    ...
                    <h3 style="font-size: 2em" class="tbk__title montserrat fs-34 fw-semibold black">All Orders</h3>
                    <!--/ Title with montserrat font and custom size, black and semibold style -->
                    <!-- Title bottom symbol -->
                ...
                <div class="account_container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
                                    <table class="table table-responsive table-hover table-striped" id="centered_table">
                                        <thead>
                                        <tr>
                                            <th>#Order</th>
                                        ...
                                        @foreach($userOrders as $order)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    <a type="button" href="{{route('user.orders.single',$order->id)}}" class="btn btn-sm btn-default">More Info</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        @else
                                            <tr><td colspan="7" style="text-align: center"><h4>You have no orders to show yet.</h4></td></tr>
                                        @endif
                                        </tbody>
                                    </table>
                                </div>
