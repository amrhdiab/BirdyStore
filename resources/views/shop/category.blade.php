...
@section('title')
    {{$selected_category['name']}} - Shop | {{$settings['website_name']}}
@endsection
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left_sidebar col-md-9">
                    ...
                    <h1 class="page-title fw-bold">{{$selected_category['name']}}</h1>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            {
                $.ajax({
                    url:"/shop/category/{{$selected_category->slug}}/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query+"&price_filter="+price_filter,
