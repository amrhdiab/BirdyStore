...
@section('title')
    All Products - Shop | {{$settings['website_name']}}
@endsection
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left_sidebar col-md-9">
                    ...
                    <h1 class="page-title fw-bold">ALL PRODUCTS</h1>
                                ...
                                <div class="search gensearch__wrapper">
                                    <div>
                                        <input id="search_products" name="search" maxlength="20" class=" gensearch__input"
                                               type="text" size="20" placeholder="Search..." @if(!empty($query))value="{{$query}}"@endif>
                                    </div>
                                </div>
                                <!-- Search wrapper -->
                            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            {
                $.ajax({
                    url:"/shop/all/fetch_data?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query+"&price_filter="+price_filter,
