...
@section('title')
    All Brands | {{$settings['website_name']}}
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" style="padding-top: 100px">
                            ...
                            <div class="subheader-titles">
                                ...
                                <h4 class="subheader-subtitle">DISCOVER ALL OF OUR AWESOME PARTNERS</h4>
                            </div>
                            <!--/ Sub-header titles -->
                        </div>
                        <!--/ col-sm-6 -->
                    ...
                    <div class="hg-portfolio-sortable">
                        ...
                        <ul id="thumbs" class="fixclear" data-columns="5">
                            @foreach($brands as $brand)
                                <!-- Item -->
                                <li class="item kl-has-overlay @foreach($brand->categories as $category){{$category['slug']}}_sort @endforeach " data-date="{{ $category->created_at->format('d-m-Y') }}">
                                    <!-- Item wrapper -->
                                    <div class="inner-item">
                                        <!-- Intro image -->
                                        <div class="img-intro">
                                            <!-- Pop-up image -->
                                            <a href="{{asset('/storage/brands/').'/'.$brand['avatar']}}" data-type="image" data-lightbox="image" class="hoverLink"></a>

                                            <!-- Image -->
                                            <img src="{{asset('/storage/brands/').'/'.$brand['avatar']}}" alt="{{$brand['name']}}" title="{{$brand['name']}}" />
                                        ...
                                        <!-- Title -->
                                        <h4 class="title">
                                            <a href="{{route('front.single.brand',$brand['slug'])}}"><span class="name">{{$brand['name']}}</span></a>
                                        </h4>

                                        <!-- Description -->
                                        <span class="moduleDesc">{{substr($brand['description'],0,100)}}...</span>
